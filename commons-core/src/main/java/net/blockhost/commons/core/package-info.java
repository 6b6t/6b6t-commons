...
/// <pre>
/// `// Format seconds to human-readableTimeFormatter.formatSeconds(3661);// "1h 1m 1s"// Compact format for
// timersTimeFormatter.formatCompact(125);// "2:05"// Parse time stringsTimeFormatter.parseToSeconds("1h30m");//
// 5400`</pre>
///
