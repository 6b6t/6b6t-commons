...
/// <pre>
/// `import de.exlll.configlib.Comment;import de.exlll.configlib.Configuration;class MyPluginConfig{host
// address")private String host = "localhost";port")private int port = 3306;")private DatabaseSettings database = new
// DatabaseSettings();// Getters...}`</pre>
///
/// Load your configuration:
/// <pre>
/// `Path configPath = plugin.getDataFolder().toPath().resolve("config.yml");MyPluginConfig config =
// ConfigLoader.loadOrCreate(configPath, MyPluginConfig.class);`</pre>
///
