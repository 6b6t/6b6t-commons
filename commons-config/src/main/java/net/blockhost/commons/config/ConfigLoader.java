 ...
 *
 * <p>This class provides a simplified API for working with ConfigLib's YAML configurations,
...
public final class ConfigLoader {
     ...
     *
     * <p>This method uses the {@code update} strategy, which:
     * <ul>
     *   <li>Creates the file with defaults if it doesn't exist</li>
     *   <li>Adds any new fields that are in the class but not in the file</li>
     *   <li>Preserves existing values in the file</li>
     *   <li>Removes fields that are no longer in the class</li>
     * </ul>
     *
     ...
     */
    public static <T> @NotNull T loadOrCreate(@NotNull Path path, @NotNull Class<T> configClass) {
     ...
     * @return the loaded or created configuration
     */
    public static <T> @NotNull T loadOrCreate(
            @NotNull Path path, @NotNull Class<T> configClass, @NotNull YamlConfigurationProperties properties) {
        Objects.requireNonNull(path, "path");
        Objects.requireNonNull(configClass, "configClass");
    ...
    public static <T> @NotNull T loadOrCreate(
            ...
            @NotNull Consumer<YamlConfigurationProperties.Builder<?>> propertiesConsumer) {
        Objects.requireNonNull(path, "path");
        Objects.requireNonNull(configClass, "configClass");
     ...
     *
     * <p>This will overwrite any existing file at the path.
     *
     ...
     * @param <T>         the configuration type
     */
    public static <T> void save(@NotNull Path path, @NotNull Class<T> configClass, @NotNull T config) {
        Objects.requireNonNull(path, "path");
        Objects.requireNonNull(configClass, "configClass");
     ...
     *
     * <p>Unlike {@link #loadOrCreate}, this method requires the file to exist
     ...
     */
    public static <T> @NotNull T load(@NotNull Path path, @NotNull Class<T> configClass) {
        Objects.requireNonNull(path, "path");
        Objects.requireNonNull(configClass, "configClass");
     ...
     */
    public static YamlConfigurationProperties.@NotNull Builder<?> defaultPropertiesBuilder() {
